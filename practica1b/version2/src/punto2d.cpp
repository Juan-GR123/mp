...
double Punto::distancia(const Punto &p2) const // Devuelve la distancia en línea recta entre dos puntos del plano.
{
...
Punto Punto::puntoMedio(const Punto &p2) const // Devuelve un nuevo Punto que está exactamente a la mitad entre los dos puntos.
{
    Punto pMedio;
